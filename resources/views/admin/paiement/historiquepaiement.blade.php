    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <div class="card card-frame">
                <div class="card-body">
                    <h4>Historique de {{ $membre->first_name }} {{ $membre->last_name }}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid py-4">
            <div class="card">
                <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1" style="margin-bottom: 10px;">
                    <h6 style="color: #525f7f;">Montant resté: {{ $membre->portmonnaie->solde }} DT</h6>
                    <h6 style="color: #525f7f;">Montant total transféré: {{ $membre->getTotaltransactions() }}</h6>
                </div>
            </div>
        </div>
