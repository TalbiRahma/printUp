                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="category_product" class="form-control" placeholder="Tapez ici...">
                    ...
                    <div class="modal fade" id="categorieAjout" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                            <div class="modal-content">
                                <form action="{{ route('add.category_product') }}" method="POST"
                    ...
                    <tbody>
                        @foreach ($category_product as $index => $cp)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('product.all', ['category_id' => $cp->id]) }}"
