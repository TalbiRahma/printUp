                            ...
                            <div class="h-100">
                                <div class="position-sticky sticky-top">
                                    <div class="single-product-thumbnail axil-product">
                                        <div class="thumbnail">
                                            <img src="{{ asset('uploads') }}/{{ $design->photo }}" alt="Design Images">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="inner">
                                            ...
                                            <div class="product-action-wrapper d-flex-center">
                                                ...
                                                <ul class="product-action action-style-two d-flex-center mb--0">
                                                    <li class="add-to-cart"><a href="#" class="axil-btn btn-bg-primary">Personnaliser</a></li>
                                                </ul>
                                                <!-- End Product Action  -->
                                            </div>
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="nft-verified-option">
                                                            ...
                                                            <button class="verify-btn axil-btn btn-bg-secondary">Voir Boutique</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
