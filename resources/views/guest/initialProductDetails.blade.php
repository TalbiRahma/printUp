                                        ...
                                        <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                            <div class="thumbnail">
                                                <a href="{{asset('uploads')}}/{{$product->photo}}" class="popup-zoom">
                                                    <img src="{{asset('uploads')}}/{{$product->photo}}" alt="Product Images">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="inner">
                                    ...
                                    <div class="product-action-wrapper d-flex-center">
                                        ...
                                        <ul class="product-action d-flex-center mb--0">
                                            <li class="add-to-cart"><a href="cart.html" class="axil-btn btn-bg-p²rimary">Personnalisé</a></li>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <div class="product-price-variant">
                                        ...
                                        <span class="price current-price"> TND</span>
                                    </div>
