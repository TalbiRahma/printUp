<div class="btn-group dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end">
        <li class="text-center">
            <!--<button class="dropdown-item" type="button">Nom d'admin</button>-->
            ...
            <div class="d-flex px-2">
                ...
                <div class="my-auto">
                    <button class="dropdown-item btn-inner--text" type="button">
        ...
        <li><a href="admin/edit"><button class="dropdown-item" type="button">
          <span class="btn-inner--icon"><i class="ni ni-settings-gear-65"></i></span>
                <span class="btn-inner--text text-center ps-2">Modifier profil</span></button></a></li>
                <li><button class="dropdown-item" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                          ...
                          <span class="btn-inner--text text-center ps-2">Se déconnecter</span></button></li>
        <hr class="horizontal dark mt-0">
        <li class="text-center">
