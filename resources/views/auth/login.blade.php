                    ...
                    <div class="axil-signin-form" >
                        ...
                        <form class="singin-form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between mt-3">
                                <button type="submit" class="axil-btn btn-bg-primary submit-btn">{{ __('Se connecter') }}</button>
                                @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="forgot-btn">{{ __('Mot de passe oublié ?') }}</a>
                                @endif
                            </div>
                        </form>
                    </div>
